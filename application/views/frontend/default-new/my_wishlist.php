...
<section class="wish-list-body gp-student-shell">
    <div class="container">
        <?php gp_ds_page_title(get_phrase('Wishlist')); ?>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                ...
                $gp_wishlist_tiles = 0;
                ob_start();
                foreach(json_decode($wishlist, true) as $course_id):
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="gp-student-tile">
                            ...
                            <div class="gp-student-tile-body">
                                ...
                                <div class="gp-student-tile-foot">
                                    <div class="gp-student-tile-price">
                                    ...
                                    <div class="gp-student-tile-cta">
                                       <?php if(is_purchased($course['id'])): ?>
                                            <span class="btn btn-primary gp-student-cta checkPropagation" onclick="redirectTo('<?php echo site_url('home/lesson/'.slugify($course['title']).'/'.$course['id']) ?>');"><?php echo get_phrase('Start Now'); ?></span>
                                        <?php else: ?>
                                            <span class="btn btn-primary gp-student-cta"><?php echo site_phrase('Enroll Now')?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                             </div>
                ...
                <?php endforeach;
                $gp_wishlist_html = ob_get_clean();
                if ($gp_wishlist_tiles === 0):
                    ob_start();
                    ?>
                    <h4><?php echo get_phrase('Wishlist'); ?></h4>
                    ...
                    echo '<div class="row">'.$gp_wishlist_html.'</div>';
                endif;
                ?>
            </div>
        </div>
