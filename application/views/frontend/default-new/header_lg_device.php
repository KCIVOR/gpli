...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    <a class="navbar-brand logo pt-0" href="<?php echo site_url(); ?>">
      <img loading="lazy" class="gp-logo-on-light" src="<?php echo site_url('uploads/system/' . get_frontend_settings('dark_logo')) ?>"
        alt="Logo" />
      <img loading="lazy" class="gp-logo-on-dark" src="<?php echo site_url('uploads/system/' . get_frontend_settings('light_logo')) ?>"
        alt="Logo" />
    </a>
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="header-search mt-2 w-100 flex-column">
                  <div class="search-container w-100">
                    <input id="headerSearchBarLg" name="query" type="text"
                      ...
                      placeholder="<?php echo get_phrase('Search') . ' ' . get_phrase('courses'); ?>"
                      value="<?php echo isset($_GET['query']) ? $_GET['query'] : ''; ?>">
                    <button type="submit"
                      class="header-search-icon border-0 text-16px <?php echo isset($_GET['query']) ? '' : 'd-hidden'; ?>"><i
                        class="fas fa-search"></i></button>
                    <label for="headerSearchBarLg"
                      class="header-search-icon text-16px <?php echo isset($_GET['query']) ? 'd-hidden' : ''; ?>"><i
      ...
      <?php else: ?>
        <form class="gp-header-search" action="<?php echo site_url('home/courses'); ?>" method="get">
          <div class="header-search py-0 px-0">
            <div class="search-container">
              <input id="headerSearchBarLg" name="query" type="text"
                ...
                value="<?php echo isset($_GET['query']) ? $_GET['query'] : ''; ?>">
              <button type="submit"
                class="header-search-icon border-0 text-16px <?php echo isset($_GET['query']) ? '' : 'd-hidden'; ?>">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M8.625 16.3125C4.3875 16.3125 0.9375 12.8625 0.9375 8.62496C0.9375 4.38746 4.3875 0.937458 8.625 0.937458C12.8625 0.937458 16.3125 4.38746 16.3125 8.62496C16.3125 12.8625 12.8625 16.3125 8.625 16.3125ZM8.625 2.06246C5.0025 2.06246 2.0625 5.00996 2.0625 8.62496C2.0625 12.24 5.0025 15.1875 8.625 15.1875C12.2475 15.1875 15.1875 12.24 15.1875 8.62496C15.1875 5.00996 12.2475 2.06246 8.625 2.06246Z"
                    fill="currentColor" />
                  <path
                    d="M16.4991 17.0625C16.3566 17.0625 16.2141 17.01 16.1016 16.8975L13.4991 14.2951C13.2816 14.0776 13.2816 13.7176 13.4991 13.5001C13.7166 13.2826 14.0766 13.2826 14.2941 13.5001L16.8966 16.1025C17.1141 16.32 17.1141 16.68 16.8966 16.8975C16.7841 17.01 16.6416 17.0625 16.4991 17.0625Z"
                    fill="currentColor" />
                </svg>
              </button>
              <label for="headerSearchBarLg"
                class="header-search-icon text-16px <?php echo isset($_GET['query']) ? 'd-hidden' : ''; ?>">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M8.625 16.3125C4.3875 16.3125 0.9375 12.8625 0.9375 8.62496C0.9375 4.38746 4.3875 0.937458 8.625 0.937458C12.8625 0.937458 16.3125 4.38746 16.3125 8.62496C16.3125 12.8625 12.8625 16.3125 8.625 16.3125ZM8.625 2.06246C5.0025 2.06246 2.0625 5.00996 2.0625 8.62496C2.0625 12.24 5.0025 15.1875 8.625 15.1875C12.2475 15.1875 15.1875 12.24 15.1875 8.62496C15.1875 5.00996 12.2475 2.06246 8.625 2.06246Z"
                    fill="currentColor" />
      ...
      <div class="right-menubar ms-auto ">
        ...
        <div class="wisth_tgl_div">
          <div class="wisth_tgl_2div">
            <a class="menu_pro_cart_tgl">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M12.3678 17.0625H5.62532C4.33532 17.0625 3.36782 16.7175 2.76782 16.035C2.16782 15.3525 1.93531 14.3625 2.09281 13.08L2.76782 7.455C2.96282 5.7975 3.38282 4.3125 6.30782 4.3125H11.7078C14.6253 4.3125 15.0453 5.7975 15.2478 7.455L15.9228 13.08C16.0728 14.3625 15.8478 15.36 15.2478 16.035C14.6253 16.7175 13.6653 17.0625 12.3678 17.0625ZM6.30031 5.4375C4.14031 5.4375 4.03532 6.29249 3.87782 7.58249L3.20282 13.2075C3.09032 14.16 3.22532 14.8575 3.60782 15.285C3.99032 15.7125 4.66532 15.93 5.62532 15.93H12.3678C13.3278 15.93 14.0028 15.7125 14.3853 15.285C14.7678 14.8575 14.9028 14.16 14.7903 13.2075L14.1153 7.58249C13.9578 6.28499 13.8603 5.4375 11.6928 5.4375H6.30031Z"
                  fill="currentColor" />
                <path
                  d="M12 6.5625C11.6925 6.5625 11.4375 6.3075 11.4375 6V3.375C11.4375 2.565 10.935 2.0625 10.125 2.0625H7.875C7.065 2.0625 6.5625 2.565 6.5625 3.375V6C6.5625 6.3075 6.3075 6.5625 6 6.5625C5.6925 6.5625 5.4375 6.3075 5.4375 6V3.375C5.4375 1.9425 6.4425 0.9375 7.875 0.9375H10.125C11.5575 0.9375 12.5625 1.9425 12.5625 3.375V6C12.5625 6.3075 12.3075 6.5625 12 6.5625Z"
                  fill="currentColor" />
              </svg>
        ...
        <?php if (!$user_id): ?>
          <a href="<?php echo site_url('login'); ?>" class="gp-login-link"><?php echo get_phrase('Login'); ?></a>
          <?php if (get_settings('public_signup') == 'enable'): ?>
            <a href="<?php echo site_url('sign_up'); ?>"
              class="ctBtn btn btn-primary"><?php echo get_phrase('Join Now'); ?></a>
          <?php endif; ?>
        <?php endif; ?>
            ...
            <div class="menu_pro_tgl_bg">
              <div class="path-pos">
                <div class="user-images">
                  <a href="javascript:;"><img loading="lazy"
                      src="<?php echo $this->user_model->get_user_image_url($user_id); ?>" alt="User Image" /></a>
                  <div class="user-info">
                ...
                <ul>
                  <?php if ($user_login): ?>
                        ...
                        <a href="<?php echo site_url('user/dashboard'); ?>">
                          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                              ...
                              stroke="#99A1B7" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                    ...
                    <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/my_courses'); ?>">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 9.15002H11.25" stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10"
                            stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M6 12.15H9.285" stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10"
                            stroke-linecap="round" stroke-linejoin="round" />
                          <path
                            d="M7.5 4.5H10.5C12 4.5 12 3.75 12 3C12 1.5 11.25 1.5 10.5 1.5H7.5C6.75 1.5 6 1.5 6 3C6 4.5 6.75 4.5 7.5 4.5Z"
                            stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                          <path
                            d="M12 3.01501C14.4975 3.15001 15.75 4.07251 15.75 7.50002V12C15.75 15 15 16.5 11.25 16.5H6.75C3 16.5 2.25 15 2.25 12V7.50002C2.25 4.08001 3.5025 3.15001 6 3.01501"
                            stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                        </svg>
                    ...
                    <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/my_messages'); ?>">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            ...
                            stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                          <path d="M12.75 6.75L10.4025 8.625C9.63 9.24 8.3625 9.24 7.59 8.625L5.25 6.75" stroke="#99A1B7"
                    ...
                    <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/purchase_history'); ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M10 21C10 21.552 9.55501 22 9.005 22C8.45701 22 8 21.552 8 21C8 20.448 8.43499 20 8.98499 20H9.005C9.55501 20 10 20.448 10 21ZM17.005 20H16.985C16.435 20 16 20.448 16 21C16 21.552 16.457 22 17.005 22C17.555 22 18 21.552 18 21C18 20.448 17.555 20 17.005 20ZM21.459 8.44701L20.444 14.617C20.185 16.046 19.574 17.499 17 17.499H8.73401C7.49801 17.499 6.43403 16.576 6.25903 15.353L4.74902 4.78799C4.64502 4.05399 4.00601 3.5 3.26501 3.5H3C2.724 3.5 2.5 3.276 2.5 3C2.5 2.724 2.724 2.5 3 2.5H3.26599C4.50199 2.5 5.56597 3.423 5.74097 4.646L5.86304 5.5H19C19.744 5.5 20.443 5.82699 20.92 6.39799C21.396 6.969 21.592 7.71601 21.459 8.44701ZM19.615 13.5H13C12.724 13.5 12.5 13.276 12.5 13C12.5 12.724 12.724 12.5 13 12.5H19.7791L20.473 8.276C20.554 7.829 20.436 7.381 20.151 7.039C19.865 6.696 19.445 6.5 18.999 6.5H6.005L7.25 15.212C7.354 15.946 7.99301 16.5 8.73401 16.5H17C18.754 16.5 19.218 15.778 19.459 14.447L19.615 13.5Z"
                            fill="#99A1B7" />
                        </svg>
                  ...
                  <li class="user-dropdown-menu-item">
                    <a href="<?php echo site_url('login/logout'); ?>">
                      <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M12.3874 16.7027L12.2899 16.7027C8.95991 16.7027 7.35491 15.3902 7.07741 12.4502C7.04741 12.1427 7.27241 11.8652 7.58741 11.8352C7.88741 11.8052 8.17241 12.0377 8.20241 12.3452C8.41991 14.7002 9.52991 15.5777 12.2974 15.5777L12.3949 15.5777C15.4474 15.5777 16.5274 14.4977 16.5274 11.4452L16.5274 6.55523C16.5274 3.50273 15.4474 2.42273 12.3949 2.42273L12.2974 2.42273C9.51491 2.42273 8.40491 3.31523 8.20241 5.71523C8.16491 6.02273 7.90241 6.25523 7.58741 6.22523C7.27241 6.20273 7.04741 5.92523 7.06991 5.61773C7.32491 2.63273 8.93741 1.29773 12.2899 1.29773L12.3874 1.29773C16.0699 1.29773 17.6449 2.87273 17.6449 6.55523L17.6449 11.4452C17.6449 15.1277 16.0699 16.7027 12.3874 16.7027Z"
                          fill="#99A1B7" />
                        <path
                          d="M12.2069 9.5625L3.67188 9.5625C3.36438 9.5625 3.10938 9.3075 3.10938 9C3.10938 8.6925 3.36437 8.4375 3.67187 8.4375L12.2069 8.4375C12.5144 8.4375 12.7694 8.6925 12.7694 9C12.7694 9.3075 12.5144 9.5625 12.2069 9.5625Z"
                          fill="#99A1B7" />
                        <path
                          d="M5.34607 12.075C5.20357 12.075 5.06107 12.0225 4.94857 11.91L2.43607 9.39751C2.21857 9.18001 2.21857 8.82001 2.43607 8.60251L4.94857 6.09C5.16607 5.8725 5.52607 5.8725 5.74357 6.09C5.96107 6.3075 5.96107 6.6675 5.74357 6.885L3.62857 9.00001L5.74357 11.115C5.96107 11.3325 5.96107 11.6925 5.74357 11.91C5.63857 12.0225 5.48857 12.075 5.34607 12.075Z"
                          fill="#99A1B7" />
                      </svg>
    ...
    <form action="<?php echo site_url('home/courses'); ?>" method="get" class="inline-form">
      <div class="mobile-search test">
        ...
        <input value="<?php echo isset($_GET['query']) ? $_GET['query'] : ''; ?>" name="query" class="form-control"
          type="text" placeholder="<?php echo get_phrase('Search') . ' ' . get_phrase('courses'); ?>" />
      </div>
    </form>
