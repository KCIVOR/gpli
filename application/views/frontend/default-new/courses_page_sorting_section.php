<div class="list-card-control fCardsection gp-catalog-toolbar">
    <div class="etopCourseHead d-flex justify-content-end align-items-center">
            <button class="btn list-btn <?php if($layout == 'grid') echo 'active'; ?>" title="<?php echo get_phrase('Grid view') ?>" data-bs-toggle="tooltip" onclick="actionTo('<?php echo site_url('home/set_layout_to_session?layout=grid'); ?>', 'post')">
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.55 4.66163H1.45C0.925273 4.66163 0.5 4.23626 0.5 3.71163C0.5 3.18699 0.925273 2.76163 1.45 2.76163H18.55C19.0747 2.76163 19.5 3.18699 19.5 3.71163C19.5 4.23626 19.0747 4.66163 18.55 4.66163Z" fill="currentColor"/>
                <path d="M18.55 10.95H1.45C0.925273 10.95 0.5 10.5246 0.5 10C0.5 9.47537 0.925273 9.05 1.45 9.05H18.55C19.0747 9.05 19.5 9.47537 19.5 10C19.5 10.5246 19.0747 10.95 18.55 10.95Z" fill="currentColor"/>
                <path d="M11.6104 17.2H0.990391C0.664508 17.2 0.400391 16.797 0.400391 16.3C0.400391 15.803 0.664508 15.4 0.990391 15.4H11.6104C11.9363 15.4 12.2004 15.803 12.2004 16.3C12.2004 16.797 11.9363 17.2 11.6104 17.2Z" fill="currentColor"/>
                </svg>
              </button>
