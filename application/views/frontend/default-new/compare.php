...
<section class="compare-card courses-card">
    <div class="container">
        ...
        <?php
            ...
            $number_of_courses = isset($_GET) && count($_GET) ? count($_GET)/2:0;
        ?>

        <!-- Toolbar: pick up to 3 courses -->
        <div class="compare-toolbar">
            <div class="compare-toolbar-head">
                <span class="compare-toolbar-title"><?php echo get_phrase('Compare with '.$number_of_courses.' courses'); ?></span>
            </div>

            <form id="compare_form" action="<?php echo site_url('home/compare'); ?>" method="get" class="comparison-form compare-toolbar-fields">
                <!-- For course 1 -->
                <div class="compare-field">
                    <label><?php echo get_phrase('Course').' 1'; ?></label>
                ...
                <!-- For course 2 -->
                <div class="compare-field">
                    <label><?php echo get_phrase('Course').' 2'; ?></label>
                ...
                <!-- For course 3 -->
                <div class="compare-field">
                    <label><?php echo get_phrase('Course').' 3'; ?></label>
            ...
            <div class="compare-slot">
                ...
                <?php else: ?>
                    <div class="compare-empty-state">
                        ...
                        <p><?php echo site_phrase('Select a course'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="container">
        ...
        <table class="table">
                <thead>
                  ...
                  <tbody>
                    <tr>
                      <th scope="row"><?php echo get_phrase('Expiry period') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Made In') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Last Updated At') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Level') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                          <div class="level">
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Total Lectures') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Total Quizzes') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Total Duration') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Total Enrolment') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Number Of Reviews') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Avg Rating') ?></th>
                      <td>
                        <?php
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Short Description') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Outcomes') ?></th>
                      <td>
                        <?php if(isset($course_1_details['title'])): ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo get_phrase('Requirements') ?></th>
                      <td class="border-bottom">
                        <?php if(isset($course_1_details['title'])): ?>
                            <div class="course-description requirements">
                                <ul>
