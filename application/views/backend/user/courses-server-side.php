...
gp_ds_page_title(
    ...
    gp_ds_button(get_phrase('add_new_course'), [
        'href'    => site_url('user/course_form/add_course'),
        'variant' => 'primary',
    ], true)
);
?>
<div class="gp-courses-page">
    <div class="gp-dash-stats">
        <a class="gp-dash-stat" href="<?php echo site_url('user/courses?category_id=all&status=active&price=all&button='); ?>">
            <span class="gp-dash-stat-icon"><i class="dripicons-link"></i></span>
            <span class="gp-dash-stat-value">
                <?php echo $this->crud_model->get_status_wise_courses_for_instructor('active')->num_rows(); ?>
            </span>
            <span class="gp-dash-stat-label"><?php echo get_phrase('active') . ' ' . get_phrase('courses'); ?></span>
        </a>
        <a class="gp-dash-stat" href="<?php echo site_url('user/courses?category_id=all&status=pending&price=all&button='); ?>">
            <span class="gp-dash-stat-icon"><i class="dripicons-link-broken"></i></span>
            <span class="gp-dash-stat-value">
                <?php echo $this->crud_model->get_status_wise_courses_for_instructor('pending')->num_rows(); ?>
            </span>
            <span class="gp-dash-stat-label"><?php echo get_phrase('pending') . ' ' . get_phrase('courses'); ?></span>
        </a>
        <a class="gp-dash-stat" href="<?php echo site_url('user/courses?category_id=all&status=draft&price=all&button='); ?>">
            <span class="gp-dash-stat-icon"><i class="dripicons-bookmark"></i></span>
            <span class="gp-dash-stat-value">
                <?php echo $this->crud_model->get_status_wise_courses_for_instructor('draft')->num_rows(); ?>
            </span>
            <span class="gp-dash-stat-label"><?php echo get_phrase('draft') . ' ' . get_phrase('courses'); ?></span>
        </a>
        <a class="gp-dash-stat" href="<?php echo site_url('user/courses?category_id=all&status=all&price=free&button='); ?>">
            <span class="gp-dash-stat-icon"><i class="dripicons-star"></i></span>
            <span class="gp-dash-stat-value"><?php echo $this->crud_model->get_free_and_paid_courses('free', $this->session->userdata('user_id'))->num_rows(); ?></span>
            <span class="gp-dash-stat-label"><?php echo get_phrase('free') . ' ' . get_phrase('courses'); ?></span>
        </a>
        <a class="gp-dash-stat" href="<?php echo site_url('user/courses?category_id=all&status=all&price=paid&button='); ?>">
            <span class="gp-dash-stat-icon"><i class="dripicons-tags"></i></span>
            <span class="gp-dash-stat-value"><?php echo $this->crud_model->get_free_and_paid_courses('paid', $this->session->userdata('user_id'))->num_rows(); ?></span>
    ...
    ob_start();
    ?>
    <form class="gp-courses-filters gp-courses-filters--4" action="<?php echo site_url('user/courses'); ?>" method="get">
