        ...
        <li class="side-nav-item">
            ...
            <ul class="side-nav-second-level                                            				                                 <?php if ($page_name == 'ebook_edit') {
                ...
                <li class="<?php if ($page_name == 'ebook_payment_history') {
                           ...
                           ?>">
                    <a href="javascript: void(0);" class="<?php if ($page_name == 'admin_revenue' || $page_name == 'instructor_revenue'): ?> active<?php endif; ?>"
...
?>"> <a href="<?php echo site_url('admin/purchase_history'); ?>"><?php echo get_phrase('purchase_history'); ?></a> </li>
        ...
        <?php if (has_permission('announcements')): ?>
        <li class="side-nav-item<?php if ($page_name == 'announcements' || $page_name == 'announcement_add' || $page_name == 'announcement_edit'): ?> active<?php endif; ?>">
            <a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'announcements' || $page_name == 'announcement_add' || $page_name == 'announcement_edit'): ?> active<?php endif; ?>">
                <i class="far fa-sticky-note"></i> <span> <?php echo get_phrase('Announcements'); ?> </span> <span class="menu-arrow"></span>
            </a>
            <ul class="side-nav-second-level" aria-expanded="false">
                <li class="<?php if ($page_name == 'announcements' || $page_name == 'announcement_edit') { echo 'active'; } ?>">
                    <a href="<?php echo site_url('admin/announcements'); ?>"><?php echo get_phrase('All announcements'); ?></a>
                </li>
                <li class="<?php if ($page_name == 'announcement_add') { echo 'active'; } ?>">
                    <a href="<?php echo site_url('admin/announcement_form/add_announcement_form'); ?>"><?php echo get_phrase('Add announcement'); ?></a>
                </li>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li
            ...
            <ul class="side-nav-second-level" aria-expanded="false">
                ...
                <li class="<?php if ($page_name == 'instructors_pending_blog') {
                           ...
                           ?>">
                    <a href="<?php echo site_url('admin/instructors_pending_blog'); ?>"><?php echo get_phrase('pending_blog'); ?> <span
        ...
        <li
            ...
            <ul class="side-nav-second-level" aria-expanded="false">
                ...
                <li class="<?php if ($page_name == 'badges') {
                                   echo 'active';
                           }
                           ?>">
                    <a href="<?php echo site_url('admin/badges'); ?>"><?php echo get_phrase('Gamification Badges'); ?></a>
                </li>

                <li class="<?php if ($page_name == 'seo_settings') {
                                   echo 'active';
                           }
                           ?>">
                ...
                <li class="<?php if ($page_name == 'sitemap_settings') {
                                   echo 'active';
                           }
                           ?>">
...
?>">
                ...
                <li class="<?php if ($page_name == 'home_page_builder') {
                                   echo 'active';
                           }
                           ?>">
                    <a href="<?php echo site_url('admin/home_page_builder'); ?>"><?php echo get_phrase('home_page_builder'); ?></a>
                </li>
