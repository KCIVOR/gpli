        ...
        ?>
		    	<form action="<?php echo site_url('admin/custom_page/update/'.$custom_page['custom_page_id']); ?>" method="post" enctype="multipart/form-data">
		    		<div class="form-group">
		    			...
		    			<input type="text" value="<?php echo htmlspecialchars_decode_($custom_page['page_title']); ?>" class="form-control" name="page_title" id="page_title" placeholder="<?php echo get_phrase('enter_page_title'); ?>" required>
		    		</div>

		    		<div class="form-group">
		    			<label for="summernote-basic"><?php echo get_phrase('page_content'); ?></label>
		    			<textarea name="page_content" id="summernote-basic"><?php echo htmlspecialchars_decode_($custom_page['page_content']); ?></textarea>
		    		</div>

		    		<div class="form-group">
			    		<label for="button_title"><?php echo get_phrase('button_title'); ?></label>
			    		<input class="form-control" type="text" value="<?php echo htmlspecialchars_decode_($custom_page['button_title']); ?>" id="button_title" name="button_title">
			    	</div>
		    		...
		    		<div class="form-group">
			    		...
			    		<div class="input-group">
			    			...
			    			<input class="form-control" value="<?php echo htmlspecialchars_decode_($custom_page['page_url']); ?>" type="text" id="page_url" name="page_url">
			    		</div>
			    	</div>
