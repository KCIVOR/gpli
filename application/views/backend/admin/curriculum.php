                ...
                <div class="card-body">
                    ...
                    <div class="gp-curriculum-section-head">
                        ...
                        <div class="card-widgets gp-curriculum-section-actions justify-content-center alignToTitle display-none" id="widgets-of-section-<?php echo $section['id']; ?>">
                            ...
                            <a href="javascript:;" onclick="confirm_modal('<?php echo site_url('admin/sections/'.$course_id.'/delete'.'/'.$section['id']); ?>');" data-toggle="tooltip" title="<?php echo get_phrase('delete_section'); ?>"><i class="mdi mdi-window-close"></i></a>
                        </div>
                    </div>
