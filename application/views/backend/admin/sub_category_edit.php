...
gp_ds_page_title(get_phrase('edit_sub_category'));
?>
...
<div class="gp-courses-page">
    <div class="row justify-content-center">
        <div class="col-xl-7">
            ...
            ob_start();
            ?>
                    <form action="<?php echo site_url('admin/sub_categories/0/edit/'.$sub_category_id); ?>" method="post" role="form">
                        <div class="form-group">
                            <label for="sub_category_code"><?php echo get_phrase('sub_category_code'); ?></label>
                            <input type="text" id="sub_category_code" name="code" class="form-control" readonly value="<?php echo $data['code']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sub_category_title" name="name" class="form-control" required value="<?php echo $data['name']; ?>">
                        </div>

                        <?php echo gp_ds_button(get_phrase('update_sub_category'), ['type' => 'submit', 'variant' => 'primary'], true); ?>
                    </form>
            <?php
            $body = ob_get_clean();
            gp_ds_card([
                'title' => get_phrase('sub_category_edit'),
                'body'  => $body,
            ]);
            ?>
        </div>
