<?php gp_ds_page_title(get_phrase('add') . ' ' . get_phrase('category')); ?>
...
<div class="gp-courses-page">
    <div class="row justify-content-center">
        <div class="col-xl-7">
            ...
            ob_start();
            ?>
                    <form class="required-form gp-category-form" action="<?php echo site_url('admin/categories/add'); ?>" method="post" enctype="multipart/form-data">
            ...
            $body = ob_get_clean();
            gp_ds_card([
                'title' => get_phrase('category_add_form'),
                'body'  => $body,
            ]);
            ?>
        </div><!-- end col-->
