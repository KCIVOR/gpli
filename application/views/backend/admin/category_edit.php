...
<?php gp_ds_page_title(get_phrase('update') . ' ' . get_phrase('category')); ?>
...
<div class="gp-courses-page">
  <div class="row justify-content-md-center">
    <div class="col-xl-6">
      ...
      ob_start();
      ?>
            <form class="required-form gp-category-form" action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <?php gp_ds_badge(get_phrase('select_none_to_create_a_parent_category'), 'neutral'); ?>
              </div>
      ...
      $body = ob_get_clean();
      gp_ds_card([
          'title' => get_phrase('update_category_form'),
          'body'  => $body,
      ]);
      ?>
    </div><!-- end col-->
