<?php gp_ds_page_title(get_phrase('courses'), '<a href="' . site_url('admin/course_form/add_course') . '" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i>' . get_phrase('add_new_course') . '</a>'); ?>
<div class="row">
    <div class="col-12">
